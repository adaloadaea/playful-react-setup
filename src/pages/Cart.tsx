...
import { Minus, Plus, X, ShoppingBag, ArrowLeft, Upload, Save, Edit2, ChevronRight, ChevronLeft } from 'lucide-react';
...
const Cart = () => {
  ...
  const onSubmit = (data: OrderForm) => {
    console.log("Form data:", data, "Selected file:", selectedFile);
