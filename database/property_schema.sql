...
INSERT IGNORE INTO properties (id, title, address, price, type, bedrooms, bathrooms, area, rating, status, image_url, property_type)
VALUES
...
INSERT IGNORE INTO properties (id, title, address, price, type, workstations, meeting_rooms, area, rating, status, image_url, property_type)
VALUES
