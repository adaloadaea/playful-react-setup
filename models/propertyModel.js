...
class Property {
    ...
    try {
      ...
      const [result] = await connection.query(
        `INSERT INTO properties (
          id, title, address, price, type, bedrooms, bathrooms, area,
  ...
  static async update(id, propertyData) {
    ...
    try {
      ...
      if (property_type === 'office' && 
          (wifi !== undefined || parking !== undefined || coffee !== undefined ||
        ...
        if (amenities.length > 0) {
          ...
          await connection.query(
            ...
            WHERE property_id = ?`,
            [
              wifi !== undefined ? wifi : null,
              parking !== undefined ? parking : null,
              coffee !== undefined ? coffee : null,
              reception !== undefined ? reception : null,
              secured !== undefined ? secured : null,
              accessible !== undefined ? accessible : null,
              printers !== undefined ? printers : null,
              kitchen !== undefined ? kitchen : null,
              flexible_hours !== undefined ? flexible_hours : null,
              id
            ]
          );
        } else {
